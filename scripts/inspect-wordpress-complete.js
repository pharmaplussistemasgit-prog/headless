/**
 * INSPECTOR COMPLETO DE WORDPRESS/WOOCOMMERCE
 * 
 * Este script mapea TODA la estructura de WordPress usando WooCommerce API:
 * - Productos (todos los campos, meta, atributos)
 * - Atributos de productos (laboratorios, etc.)
 * - Categorías
 * - Tags
 * - Taxonomías custom
 * - Custom fields
 ...
 * - Clientes (estructura)
 * 
 * Genera un reporte JSON completo con TODA la información
 */
...
async function main() {
    ...
    try {
        // 1. Atributos de productos (INCLUYE LABORATORIOS)
