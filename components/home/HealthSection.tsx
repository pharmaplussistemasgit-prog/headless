                        ...
                        <div className="mb-8">
                            <div className="flex items-center justify-between">
                                <h2 className="text-2xl md:text-3xl font-bold italic">
                                    <span className="text-[var(--color-pharma-blue)]">Salud</span>{' '}
                                    <span className="text-[var(--color-pharma-green)]">y medicamentos</span>
                                </h2>
                                <Link href="/categoria/salud" className="text-xs font-medium text-gray-400 hover:text-[var(--color-pharma-blue)] flex items-center gap-1 transition-colors">
